...
public enum Config implements ConfigEnum {
    ...
    WORLD_GROUPS("World-Groups", Map.of("1", List.of("world", "world_nether", "world_the_end"))),
    ...
    COOLDOWN("Cooldown", 0),
    CUSTOM_ITEM_DISPLAY_NAMES_IS_WEAPON("Custom-Item-Display-Names-Is-Weapon", List.of("&6SUPER COOL GOLDEN APPLE", "SICKNAME")),
